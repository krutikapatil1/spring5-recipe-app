...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        Optional<UnitOfMeasure> unitOfMeasureOptionalCups = unitOfMeasureRepository.findByDescription("Cup");
        if (!unitOfMeasureOptionalCups.isPresent()) {
            throw new RuntimeException("Expected UOM not found");
        }
        ...
        UnitOfMeasure dashUom = unitOfMeasureOptionalDash.get();
        ...
        guacRecipe.setUrl("www.example.com");
        guacRecipe.setSource("Simply Recipes");
        guacRecipe.setDirections("Cut the avocado, remove flesh: Cut the avocados in half. Remove the pit. " +
        ...
        tacosRecipe.setUrl("www.simplyrecipes.com");
